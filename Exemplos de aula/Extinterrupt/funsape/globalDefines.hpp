...
#define __FUNSAPE_AVR8_LIB_GLOBAL_DEFINES_HPP   202303
...
#include "pinout.hpp"
#if !defined(__FUNSAPE_AVR8_LIB_PINOUT_HPP)
#    error "Header file (funsapeAvrPinout.hpp) is corrupted!"
#elif __FUNSAPE_AVR8_LIB_PINOUT_HPP != __FUNSAPE_AVR8_LIB_GLOBAL_DEFINES_HPP
...
#ifndef assertParam
#   define assertParam(expr)            ((expr) ? (void)0U : assertFailed((char_t *)__FILE__, __LINE__))
#endif
...
void assertFailed(char_t *file_p, uint32_t line_p);
void weakened assertFailed(char_t *file_p, uint32_t line_p)
{
    return;
}
...
#define delayCycles(cycles_p)           __builtin_avr_delay_cycles(cycles_p)
