...
*/
/**************************************************************************/
Adafruit_Fingerprint::Adafruit_Fingerprint(Usart0 *hs,
                                           uint32_t password) {
...
void Adafruit_Fingerprint::begin(uint32_t baudrate) {
  delayMs(1000); // one second delay to let the sensor 'boot up'
}
...
*/
/**************************************************************************/
bool_t Adafruit_Fingerprint::verifyPassword(void) {
